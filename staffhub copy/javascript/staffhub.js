...
document.addEventListener(
    ...
    async () => {
        ...
        /*
        Load content BEFORE building navigation
        or rendering any permission-dependent UI.
        */
        await loadContent();
...
async function renderStaffUpdates() {
    ...
    try {
        ...
        /*
        Founder-only access control button.
        */
...
async function renderCurrentStaff() {
    ...
    try {
        ...
        */
        ...
        because their role config category is CHIEFS.
        */
        ...
        */
        ...
        if (!sortedGroups.length) {
            ...
            container.innerHTML = `
                <div class="empty-state">
                    No current Xotic staff members were found.
                </div>
            `;
            ...
            sortedGroups
                .map(
                    group => {
                        ...
                        return `
                            <section
                                class="current-staff-group">

                                <div
                                    class="current-staff-group-header">

                                    <div>
                                        <span
                                            class="current-staff-group-kicker">
                                            XOTIC ESPORTS
                                        </span>

                                        <h2
                                            class="current-staff-group-title">
                                            ${escapeHtml(
                                                displayName
                                            )}
                                        </h2>
                                    ...
                                    <span
                                        class="current-staff-group-count">
        ...
        if (errorBox) {
            ...
            errorBox.innerHTML = `
                <strong>
                    Unable to load the staff roster.
                </strong>
